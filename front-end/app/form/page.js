...
import { seeFormData, seeTextArea } from "@/lib/actions";
...
export default function Page() {
  ...
  return (
    <>
      <form
        action={seeFormDataWithAddition}
      ...
      <form action={seeTextArea}>
      <textarea name="entry" rows={10} onKeyDown={handleKeyDown}/>
      </form>
    </>
  );
}
